...
<title>Food Description - Takeaway</title>

<!-- Page Title -->
<section class="page-title" style="background-image: url(assets/images/background/11.jpg)">
    <div class="auto-container">
        <h1>Food Details - Takeaway</h1>
    </div>
</section>
                ...
                <div class="product-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <h4>
                                <a href="food_description_takeaway.php?id=<?php echo $row["id"]; ?>">
                            ...
                            <div class="lower-box">
                                <a href="food_description_takeaway.php?id=<?php echo $row["id"]; ?>" class="theme-btn btn-style-five">
...
<script type="text/javascript">
    function add_to_cart(id, qty) {
        ...
        xhr.open("POST", "add_to_cart_takeaway.php", true);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                try {
                    ...
                    // Création d'une alerte visuelle
