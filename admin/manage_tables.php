...
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
    // ATTENTION : Cette vérification est désactivée pour le développement
    // Pour la production, décommentez les lignes suivantes :
    // header("Location: login.php");
    // exit;
    
    // En attendant, on définit un rôle par défaut pour éviter les warnings
    if (!isset($_SESSION['admin_role'])) {
        $_SESSION['admin_role'] = 'gérant'; // Rôle par défaut en mode développement
    }
}
